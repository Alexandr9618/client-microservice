...
public class PersonRestController {
    ...
    public PersonRestController(IPersonService personService, PersonMapper personMapper) {
    ...
    public Mono<PersonResponse> addPerson(@Valid @RequestBody PersonRequest request) {
        return personMapper.toMonoResponse(personService.addPerson(request));
    }

    @ResponseStatus(HttpStatus.CREATED)
    @PutMapping(value = "/{id}", consumes = MediaType.APPLICATION_JSON_VALUE)
    public Mono<PersonResponse> setUpdatePerson(@PathVariable(value = "id") String id,
                                                @RequestBody PersonRequest request) {
        return personMapper.toMonoResponse(personService.setUpdatePerson(id, request));
    }
